...
public class Us_05_ApiStepDefs {
    ...
    @And("Kullanici expected data olusturur. {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}")
    public void kullaniciExpectedDataOlusturur(String password, String username, String name, String surname, String birthDay, String ssn, String birthPlace, String phoneNumber, String gender) {
        ...
        expectedData = new US_05PostPojo(birthDay, birthPlace, gender, name, password,fakerPhoneNumber,ssn,surname,username);
