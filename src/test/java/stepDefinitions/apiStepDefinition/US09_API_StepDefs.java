...
public class US09_API_StepDefs {
    ...
    public void viceDeanEntersAValidUsernameAndPasswordThenClicksTheLoginButtonIO() {
    }

    @And("Vice Dean clicks on the Lessons section on the opened pageIO")
    public void viceDeanClicksOnTheLessonsSectionOnTheOpenedPageIO() {
    }
    ...
    public void verifyingThatTheStatusCodeIsIO(int arg0) {
    }
    ...
    public void editingTheURLForViewingTheCreatedLessonIO() {
    }
